...
# This script sets up the production environment for the 4-phase multi-platform scraper
...
echo ""
echo "Next steps:"
echo "1. Edit .env file with your API keys (ZeroBounce + Google Custom Search)"
echo "2. List available states: python3 main.py --platform houzz --list-states"
echo "3. List available cities: python3 main.py --platform houzz --list-cities california"
echo "4. Test with dry run: python3 main.py --platform houzz --dry-run --states california"
echo "5. Run full 4-phase pipeline: python3 main.py --platform houzz"
echo ""
echo "4-Phase Pipeline Commands:"
echo "  python3 main.py --help                                    # Show all options"
echo "  python3 main.py --platform houzz --list-states            # List all available US states"
echo "  python3 main.py --platform houzz --list-cities california # List cities in California"
echo "  python3 main.py --platform houzz --dry-run --states california  # Test run without scraping"
echo "  python3 main.py --platform houzz                          # Full 4-phase pipeline (all states)"
echo "  python3 main.py --platform houzz --states california texas # Run for specific states"
echo "  python3 main.py --platform houzz --no-email-verification  # Skip ZeroBounce verification (saves credits)"
echo ""
echo "Multi-Platform Support:"
echo "  python3 main.py --platform houzz --phase scrape           # Houzz platform scraping"
echo "  python3 main.py --platform architizer --phase scrape      # Architizer platform scraping"
echo ""
echo "Individual Phase Execution:"
echo "  python3 main.py --platform houzz --phase scrape --states california  # Phase 1: Platform Profile Scraping"
echo "  python3 main.py --platform houzz --phase websearch        # Phase 2: Advanced Website Email Mining"
echo "  python3 main.py --platform houzz --phase googlesearch     # Phase 3: Google Custom Search Enrichment"
echo "  python3 main.py --platform houzz --phase export           # Phase 4: ZeroBounce Verification & Export"
echo ""
echo "Advanced Options:"
echo "  python3 main.py --platform houzz --states california --max-pages 10  # Custom pagination"
echo "  python3 main.py --platform houzz --professional-types interior-designer  # Specific professions"
echo "  python3 main.py --platform houzz --list-cities california # List cities in a state"
echo "  python3 main.py --platform houzz --stats                  # Show scraping statistics"
echo "  python3 main.py --platform houzz --log-level DEBUG        # Enable debug logging"
echo ""
echo "Platform Support:"
echo "  - Houzz: All 50 US states, 7+ professional types"
echo "  - Architizer: Architectural firms and professionals"
echo ""
echo "Available States: All 50 US states supported (use --platform houzz --list-states to see all)"
